...
public class Contract {
    ...
    //https://news-at.zhihu.com/api/4/news/before/20210513
    ...
    public interface IPersenter_Details {
        void getDetails(String id);
        void show(String msg);
        void showWeb(Daily_details details);
        void showErr(String msg);
    }
    public interface UIDetailsView{
        void getDetails();
        void show(String msg);
        void showWeb(Daily_details model);
        void showErr(String msg);
    }


    public static final String START_TEXT = "<html><header><style type = text/css>";
    public static final String END_MID = "</style></header>";
    public static final String END_TEXT = "</html>";

    public static final String CSS ="article,\n" +
            "aside,\n" +
            "details,\n" +
            "figcaption,\n" +
            "figure,\n" +
            ...
            "}";
//    static {
//        CSS ="<style type = text/css>" + "article,\n" +
//                "aside,\n" +
//                "details,\n" +
//                "figcaption,\n" +
//                "figure,\n" +
